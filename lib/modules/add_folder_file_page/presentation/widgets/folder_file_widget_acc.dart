...
class FolderFileWidgetAcc extends StatelessWidget {
  final String folderNames;
  final String folderId;
  final String subFolder;
  const FolderFileWidgetAcc({Key? key, required this.folderNames, required this.folderId, required this.subFolder}) : super(key: key);
                                    ...
                                    children:  [
                                      ...
                                      Expanded(
                                        child: MyButton(text: 'File',
                                          ...
                                          borderRadius: 10,
                                          onPress: () {
                                          cubit.addMultiMediaAcc(folderNames,int.parse(folderId),subFolder+cubit.projectName.text);

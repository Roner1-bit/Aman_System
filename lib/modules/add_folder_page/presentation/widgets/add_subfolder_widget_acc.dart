...
class AddSubFolderWidgetAcc extends StatelessWidget {
  final String folderNames;
  final String folderId;
  final String subFolder;
  const AddSubFolderWidgetAcc({Key? key, required this.folderNames, required this.folderId, required this.subFolder}) : super(key: key);
                                    ...
                                    child: MyButton(text: 'Create',
                                      ...
                                      onPress: () {
                                            ...
                                            content: Text("Fill The Form")));
                                              ...
                                              cubit.addSubHeaderAcc(folderNames,int.parse(folderId),subFolder+cubit.projectName.text);
                                              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
